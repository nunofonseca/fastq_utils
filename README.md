# 
## fastq utils   ![Build Status](https://travis-ci.org/nunofonseca/fastq_utils.svg?branch=master) ![codecov](https://codecov.io/gh/nunofonseca/fastq_utils/branch/master/graph/badge.svg) [![License](http://img.shields.io/badg/licenseGPL%203brightgreen.svg?style=flat)](http://www.gnu.org/licenses/gpl-3.0.html)
...
Programs:
   ...
   10. [bam2fastq](#bam2fastq---bam-(generated-by-fastq2bam)-to-fastq-convertor)	
...
Usage: fastq2bam -a format -b out_bam -1 fastqfile1 [ -2 fastqfile2 -3 fastqfile3 -4 fastqfile4]

Currently format can be 10xV1, 10xV1a, 10xV2 or none. This will be extended to
include other single-cell RNA-seq protocols.
...
#### bam2fastq - bam (generated by fastq2bam) to fastq convertor
