...
if [ ! -e deps/samtools-1.6.tar.bz2 ] ; then
    wget -c https://sourceforge.net/projects/samtools/files/samtools/1.6/samtools-1.6.tar.bz2/download -O deps/samtools-1.6.tar.bz2
fi

tar xvjf deps/samtools-1.6.tar.bz2
pushd samtools-1.6
